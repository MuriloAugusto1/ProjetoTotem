...
public class Totem {
	public static void main(String[] args) {
		int x, y, quantidade_bebida, volume_escolhido = 0;
		...
		if (x == 2) {
			...
			if(Bigmac.isAcompanhamento() == true || Mcchicken.isAcompanhamento() == true || Mcfish.isAcompanhamento() == true) {
		...
		if (escolhido_bebida.equals("Coca-cola")) {
			...
			System.out.println("|Quantidade:                    " + quantidade_bebida);
			System.out.print("|Volume total:             "+volume_escolhido * quantidade_bebida+" mL\n");
			
			if(escolhido_bebida.equals("Coca-cola") && cocacola.isGelo() == true|| escolhido_bebida.equals("Suco de uva") && suco.isGelo() == true) {
